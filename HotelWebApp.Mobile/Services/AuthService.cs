    ...
    public class AuthService
    {
            ...
            string? phoneNumber)
        {
            try
            {
                ...
                System.Diagnostics.Debug.WriteLine($"Starting HTTP POST at {DateTime.Now:HH:mm:ss.fff}");
        ...
        public async Task<ApiResponse<bool>> ConfirmEmailAsync(string email, string token)
        {
            try
            {
